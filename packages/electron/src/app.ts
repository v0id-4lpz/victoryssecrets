...
import { buildSearchIndex as buildIndex, filterSearch as searchFilter } from 'vsv/services/search';
import { getEnvironmentComment } from 'vsv/services/environment-ops';
import type { SearchResult } from 'vsv/types/vault';
